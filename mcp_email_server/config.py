...
class EmailSettings(AccountAttributes):
    ...
    def from_env(cls) -> list[EmailSettings] | None:
        ...
        - MCP_EMAIL_<ACCOUNT>_ACCOUNT_NAME
        ...
        - MCP_EMAIL_<ACCOUNT>_IMAP_VERIFY_SSL (default: true)
        ...
        - MCP_EMAIL_<ACCOUNT>_SMTP_VERIFY_SSL (default: true)
        ...
        for key, value in os.environ.items():
            ...
            account_name = "_".join(account_parts) if account_parts else "default"
